...
export default function Navbar({toggleOffcanvas,isOffcanvasOpen,props}) {
  ...
  return (
      <>
        <nav
          className="navbar navbar-dark sticky-top fade show navbar-expand-lg bg-dark border-bottom py-0cd" data-bs-backdrop='true' data-bs-theme="dark" style={navbarStyle}
        >
